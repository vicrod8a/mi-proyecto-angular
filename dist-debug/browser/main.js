...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-BUQJHKQN.js").then((m) => m.LandingComponent)
  },
  {
    path: "auth",
    children: [
      {
        path: "login",
        loadComponent: () => import("./chunk-XLB5CTQZ.js").then((m) => m.LoginComponent)
      },
      {
        path: "register",
        loadComponent: () => import("./chunk-CTAS2LG5.js").then((m) => m.RegisterComponent)
      }
    ]
  },
  {
    path: "home",
    loadComponent: () => import("./chunk-Q5D7LUPL.js").then((m) => m.HomeComponent)
  },
  {
    path: "profile",
    loadComponent: () => import("./chunk-PZXNPVKT.js").then((m) => m.ProfileComponent)
  },
  {
    path: "group",
    loadComponent: () => import("./chunk-IXHZDB2D.js").then((m) => m.GroupComponent)
  },
  {
    path: "**",
    redirectTo: ""
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    provideAnimations(),
    providePrimeNG({
      // theme configuration removed; using CDN-provided saga-blue
    })
  ]
});
